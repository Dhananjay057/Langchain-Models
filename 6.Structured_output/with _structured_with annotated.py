...
# ✅ Schema with Annotated field descriptions
class Review(BaseModel):
    key_themes: Annotated[str, "Write down all key themes discussed in the review in a list"]
    summary: Annotated[str, "A brief summary of the review"]
    sentiment: Annotated[str, "Return Sentiment of the review: positive, negative or neutral"]
    pros: Annotated[Optional[list[str]], "List of all pros mentioned in the review"]
    cons: Annotated[Optional[list[str]], "List of all cons mentioned in the review"]
